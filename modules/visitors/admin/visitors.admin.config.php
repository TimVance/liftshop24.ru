	...
	public $variables = array (
		'base' => array (
			...
			'counter_cache_extreme' => array(
				'type' => 'checkbox',
				'name' => 'Активировать ведение Статистики CMS в режиме экстримального кэширования',
			...
			'counter_block_access_bots' => array(
				...
				'help' => 'Блокирует доступ спам-ботов к страницам сайта по имени пользовательского агента.',
				'depend' => 'counter_enable',
			),
			'counter_block_access_search_bots' => array(
				'type' => 'checkbox',
				'name' => 'Блокировать доступ для поисковых ботов по имени пользовательского агента',
				'help' => 'Блокирует доступ поисковых ботов к страницам сайта по имени пользовательского агента.',
				'depend' => 'counter_enable',
			),
		),
		'yandex' => array (
