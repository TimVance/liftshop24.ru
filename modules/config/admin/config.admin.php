...
class Config_admin extends Frame_admin
{
	...
	public $variables = array (
		'base' => array (
			...
			'sms' => array(
				'type' => 'checkbox',
				'name' => 'Подключить SMS-уведомления<br>(требуется <a href="https://smsc.ru/?ppdiafan" target="_blank">регистрация</a>).',
				// TO_DO: byteHand
				// 'help' => 'SMS-рассылки интегрирована в модули «Обратная связь», «Оформление заказа», «Комментарии», «Вопрос-Ответ» для уведолмения администраторов. А также в модуль «Рассылки» для массовой рассылки SMS. Подключеть SMS-уведомления нужно в настройках соответствующего модуля. Для включения SMS на сайте необходимо зарегистрироваться в системе [SMSC](https://smsc.ru/?ppdiafan). На хостинге должны быть открыты соответствующие порты (обычно 3800)',
				// TO_DO: SMSC
			...
			'sms_key' => array(
				...
				// TO_DO: SMSC
				'help' => 'Данные из настроек сервиса SMSC.',
				'depend' => 'sms',
			),
			'sms_id' => array(
				'type' => 'text',
