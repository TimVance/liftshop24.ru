...
f.event.handle).apply(this,c)}var b=f.extend({},this.dsetting,c),g=b.zindex||this.T(d),n={c:d.width(),d:d.height()},a=new a,x=d.attr("data-title")?d.attr("data-title"):"",D=d.attr("data-help")?d.attr("data-help"):"",B=d.attr("data-text-bottom")?d.attr("data-text-bottom"):"",e=this,A,v,u,p,r,h,s;if(0===n.d||0===n.c)f(new Image).load(function(){e.F(d,c)}).attr("src",d.attr("src"));else{d.css({visibility:"visible"});b.i=d.attr("src")||d.attr("src");for(v in b)""===b[v]&&(b[v]=this.dsetting[v]);
...
d.offsetsl();h.css({left:a.left,top:a.top})});h.mouseover(function(g){e.a.g=g.pageX;e.a.j=g.pageY;a.g=g.pageX;a.j=g.pageY;e.a.D=g.pageX;g=d.offsetsl();var k=e.a.g-g.left,n=e.a.j-g.top;e.a.z=k;e.a.A=n;e.a.u=k;e.a.v=n;e.a.p=e.a.g;e.a.q=e.a.j;e.a.B=e.a.g-10;e.a.C=e.a.j+20;h.css({left:g.left,top:g.top,cursor:b.magnifycursor});b.i=d.attr("src")||d.attr("src");b.i!==h.data("largeimage")&&(f(new Image).load(function(){f(p).remove();f(r).remove();f(u).remove();f(h).remove();f(s).remove()}).attr("src",
b.i),h.data("loadevt",q),h.data("largeimage",b.i),e.F(d,c));r.show();clearTimeout(e.a.n);clearTimeout(e.a.o)});h.mousemove(function(g){b.i=d.attr("src")||d.attr("src");b.i!==h.data("largeimage")&&(f(new Image).load(function(){f(p).remove();f(r).remove();f(u).remove();f(h).remove();f(s).remove()}).attr("src",b.i),h.data("loadevt",q),h.data("largeimage",b.i),e.F(d,c));e.a.g=g.pageX;e.a.j=g.pageY;a.g=g.pageX;a.j=g.pageY;e.a.D=g.pageX});h.mouseout(function(){clearTimeout(e.a.n);clearTimeout(e.a.o);
