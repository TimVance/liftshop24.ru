...
if(empty($result["text"]))
    ...
    <h2>Заказать '.mb_strtolower($this->htmleditor('<insert name="show_h1">')).'</h2>
    
    <p>В интернет-магазине Liftshop24.ru можно <strong>купить '.mb_strtolower($this->htmleditor('<insert name="show_h1">')).'</strong> c доставкой по всей России и странам СНГ. Доставку осуществляем в течении 28 дней.</p>
