...
{
	echo '<div class="emtycartpage">'.$this->diafan->_('Корзина пуста.').' <br /><br /> <a class="returntoshop" href="'.BASE_PATH_HREF.$result["shop_link"].'">
	<- '.$this->diafan->_('Перейти к покупкам').'</a>
	</div>';
	return;
}
...
echo '<input type="submit" value="'.$this->diafan->_('Закончить оформление', false).'">';
