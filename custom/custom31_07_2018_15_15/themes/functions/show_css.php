...
$files[] = Custom::path('css/jquery.formstyler.css');
$files[] = Custom::path('css/prettyPhoto.css');
...
if(is_array($compress_files))
{
	...
	{
		echo '<link rel="preload" href="'.BASE_PATH.$file.'?v=21" rel="stylesheet" type="text/css">';
	}
}
else
{
